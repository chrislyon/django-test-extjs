...
from n2.models import Note, NoteForm, STATUS_NOTES
...
def populate(request):
    ...
    for x in range(1,20):
        obj = Note()
        obj.titre = "Titre No %02d" % x
        obj.description = "Description de la note No %02d" % x
        obj.tag1 = "TAG1-%02d" % x
        obj.tag2 = "TAG2-%02d" % x
        obj.tag3 = "TAG3-%02d" % x
        obj.tag4 = "TAG4-%02d" % x
...
def liste(request):
    if request.method == 'POST':
        ...
        g.data_url = '/n2/'
        g.base_url = '/n2'
        g.button_new_url = '/n2/cr'
        g.button_home = '/'
        S = g.render()
        #print S
        template = 'n2/notes.html'
